...
func setUpRouters(router *gin.Engine) {
	...
	router.DELETE("/threads/:threadID/unlike", middleware.JWTAuthMiddleware, controllers.UnlikeThread)
	...
	threadGroup.DELETE("/comments/:commentID/unlike", middleware.JWTAuthMiddleware, controllers.UnlikeComment)
